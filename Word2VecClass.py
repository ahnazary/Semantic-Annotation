...
class Word2VecClass:
    ...
    def startTokenizingInputText(self):
        ...
        # Create CBOW model
    def GetCBOW(self, keyword, word):
        model1 = gensim.models.Word2Vec(self.data, min_count=1, window=5)
        #print results
        try:
    ...
    def GetSkipGram(self, keyword, word):
        model2 = gensim.models.Word2Vec(self.data, min_count=1, window=5, sg=1)
        # Print results
        try:
            print("Cosine similarity between '" + keyword + "' " +
                  "and '" + word + "' - Skip Gram : ",
